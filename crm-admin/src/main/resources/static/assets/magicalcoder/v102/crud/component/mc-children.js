...
layui.define(['jquery','laytpl','element','mc_util','mc_constant'],function(exports){
    var $ = layui.jquery,
        mc_util = layui.mc_util,
        mc_constant = layui.mc_constant,
        laytpl = layui.laytpl;
    //从url构建外键 允许不传
    var mcForeignName = mc_util.getParameter('mcForeignName')//外键名称
    var mcForeignValue = mc_util.getParameter('mcForeignValue')//外键值
