...
layui.config({base : "assets/"}).extend({"shop_config":"admin/shop/shop-config"})
layui.use(["jquery","table","shop_config","mc_children","mc_constant","mc_layui_component","mc_util","mc_rmp"],function(){
    var $ = layui.jquery
        ,layer = parent.layer === undefined ? layui.layer : top.layer
        ,table = layui.table
        ,shop_config = layui.shop_config
    ...
    ;
    var common_config = {
        tableNameRest:"shop_rest",
        tableName:"shop",
        moduleName:"shop",//sys_module的moduleName
        form:{
        }
    }
//后端请求时候的表模块规则url
...
//
    var CONFIG = $.extend(layui.shop_config,{
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
                {field: 'id', title: '店铺id', minWidth:100, align:"center",sort:true},
