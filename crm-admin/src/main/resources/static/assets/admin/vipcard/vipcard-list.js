...
layui.config({base : "assets/"}).extend({"vipcard_config":"admin/vipcard/vipcard-config"})
layui.use(["jquery","table","vipcard_config","mc_children","mc_constant","mc_layui_component","mc_util","mc_rmp"],function(){
    var $ = layui.jquery
        ,layer = parent.layer === undefined ? layui.layer : top.layer
        ,table = layui.table
        ,vipcard_config = layui.vipcard_config
    ...
    ;
    var common_config = {
        tableNameRest:"vip_card_rest",
        tableName:"vip_card",
        moduleName:"vip_card",//sys_module的moduleName
        form:{
        }
    }
//后端请求时候的表模块规则url
...
//
    var CONFIG = $.extend(layui.vipcard_config,{
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
                {field: 'id', title: '会员号', minWidth:100, align:"center",sort:true},
