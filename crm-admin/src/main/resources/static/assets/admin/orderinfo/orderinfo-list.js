...
layui.config({base : "assets/"}).extend({"orderinfo_config":"admin/orderinfo/orderinfo-config"})
layui.use(["jquery","table","orderinfo_config","mc_children","mc_constant","mc_layui_component","mc_util","mc_rmp"],function(){
    var $ = layui.jquery
        ,layer = parent.layer === undefined ? layui.layer : top.layer
        ,table = layui.table
        ,orderinfo_config = layui.orderinfo_config
    ...
    ;
    var common_config = {
        tableNameRest:"order_info_rest",
        tableName:"order_info",
        moduleName:"order_info",//sys_module的moduleName
        form:{
        }
    }
//后端请求时候的表模块规则url
...
//
    var CONFIG = $.extend(layui.orderinfo_config,{
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
                {field: 'id', title: '订单id', minWidth:100, align:"center",sort:true},
