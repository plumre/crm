...
layui.config({base : "assets/"}).extend({"user_config":"admin/user/user-config"})
layui.use(["jquery","table","user_config","mc_children","mc_constant","mc_layui_component","mc_util","mc_rmp"],function(){
    var $ = layui.jquery
        ,layer = parent.layer === undefined ? layui.layer : top.layer
        ,table = layui.table
        ,user_config = layui.user_config
    ...
    ;
    var common_config = {
        tableNameRest:"user_rest",
        tableName:"user",
        moduleName:"user",//sys_module的moduleName
        form:{
        }
    }
//后端请求时候的表模块规则url
...
//
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
                {field: 'id', title: '用户id', minWidth:100, align:"center",sort:true},
