...
layui.config({base : "assets/"}).extend({"admin_config":"admin/admin/admin-config"})
layui.use(["jquery","table","admin_config","mc_children","mc_constant","mc_layui_component","mc_util","mc_rmp"],function(){
    var $ = layui.jquery
        ,layer = parent.layer === undefined ? layui.layer : top.layer
        ,table = layui.table
        ,admin_config = layui.admin_config
    ...
    ;
    var common_config = {
        tableNameRest:"admin_rest",
        tableName:"admin",
        moduleName:"admin",//sys_module的moduleName
        form:{
        }
    }
//后端请求时候的表模块规则url
...
//
    var CONFIG = $.extend(layui.admin_config,{
    ...
    var COLS = [[
        {type: "checkbox", /*fixed:"left",*/ width:50},//全选
                {field: 'id', title: '管理员id', minWidth:100, align:"center",sort:true},
