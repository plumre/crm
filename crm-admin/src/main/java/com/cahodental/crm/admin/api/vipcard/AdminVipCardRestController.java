...
@RequestMapping("/admin/vip_card_rest/")
@RestController
public class AdminVipCardRestController extends CommonRestController<VipCard,Long> implements InitializingBean
{
    ...
    public ResponseMsg page(
        ...
        Integer count = vipCardService.getModelListCount(query);
        ...
        if(queryType==null || queryType == QUERY_TYPE_SEARCH){//普通查询
            ...
            return new ResponseMsg(count,vipCardService.getModelList(query));
        }else if(queryType == QUERY_TYPE_EXPORT_EXCEL){
            query.put("start",(page - 1) * limit);query.put("limit",limit);
            exportExcel(response,vipCardService.getModelList(query),"vip_card",
            new String[]{"会员号","余额","创建时间","修改时间"},
            new String[]{"","","",""});
        }
        return null;
    }
    ...
    public void afterPropertiesSet() throws Exception {
        super.commonService = vipCardService;
