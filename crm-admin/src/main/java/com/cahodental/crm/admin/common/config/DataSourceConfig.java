...
@MapperScan(basePackages =
        {"com.cahodental.crm.admin.**.mapper"
        ,"com.cahodental.crm.admin.rmp.**.mapper" // 如果您觉得日志有warn mapper已经存在 比较碍眼 可以注释本行
        ,"com.cahodental.crm.service.**.mapper"
        }
...
public class DataSourceConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE =
            "com.cahodental.crm.admin.model," +
            "com.cahodental.crm.admin.rmp.model," +
            "com.cahodental.crm.model";//逗号分隔多个
