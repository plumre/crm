package com.cahodental.crm.admin.rmp.common.point;

import com.cahodental.crm.admin.rmp.common.SecurityReturnCode;
...
public class MyLoginExpiredAuthenticationEntryPoint extends JsonOutWriter implements AuthenticationEntryPoint {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException) throws IOException, ServletException {
        ...
        if(servletPath.startsWith("/admin/page/")){//返回到登录超时页面 这种格式的请求都是列表页 详情页跳转 所以应该展示到登录超时页面
