package com.cahodental.crm.core.cache.redis;
...
public class RedisUtil extends RedisDefinedUtil{
    ...
    //为每个项目提供一个单独的前缀来区分 如果不填写默认给stentor.
    @Value("${spring.redis.keyPrefix:crm.}")
     ...
     * @param key 太多人用userid作为key了 所以千万别用uid 可以加个前缀
